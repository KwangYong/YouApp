...
public class ModelTextCellEditor extends DialogCellEditor {
	 ...
	 */
	public ModelTextCellEditor(Composite parent) {
	 ...
	 * @since 2.1
	 */
	public ModelTextCellEditor(Composite parent, int style) {
		super(parent, style);
		doSetValue("");
	}
