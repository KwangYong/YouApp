...
public class ModelColorPropertyDescriptor extends PropertyDescriptor {
   ...
   public ModelColorPropertyDescriptor(Object id, String displayName) {
   ...
   public CellEditor createPropertyEditor(Composite parent) {
       CellEditor editor = new ModelColorCellEditor(parent);
