...
public class FileDialogPropertyCellEditor extends DialogCellEditor {
	...
	public FileDialogPropertyCellEditor(Composite parent,String[] filter) {
		super(parent, SWT.NONE);
		this.filter = filter;
		doSetValue("");
	}
	...
	protected Object openDialogBox(Control cellEditorWindow) {
		...
		if(!dialog.getFileName().equals("")&&!ProjectManager.getInstance().isPropIntegrity(Property.ID_MEDIA,dialog.getFilterPath()+LayoutManager.SEPARATOR+dialog.getFileName()))
			return "";


		if(!dialog.getFilterPath().equals(""))
			return dialog.getFilterPath()+LayoutManager.SEPARATOR+dialog.getFileName();
		return "";
	}
